...
/*----------- Component List Size-Doubling Variant 1 ----------*/
...
void component_list_size_double_size(ComponentStats** component_list, unsigned int *list_size);
...
/*----------- Component List Size-Doubling Variant 2 ----------*/
