...
int    path_node_exists_in_lists(PathGraph *g, int x, int y); /* Returns true if the given coordinates exist as a node in open_list or closed_list. */
int    path_node_exists_in_open_list(PathGraph *g, int x, int y); /* Returns true if the supplied coordinates matches a node in the open_list */
