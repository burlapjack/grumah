...
void entity_prefab_create_player(unsigned int id, 
								 int x, int y, 
								 ComponentPosition *cp, size_t cp_list_size,
								 ComponentDraw *cd,	    size_t cd_list_size,  
								 ComponentStats *cs,	size_t cs_list_size	){
