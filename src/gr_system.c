...
extern void 
gr_system_draw_map(WINDOW *w, MapData *m, Component *c)
{
...
extern void
gr_system_draw_layer(WINDOW *w,Component *c, int draw_layer, int x_offset, int y_offset) {
	for (int i = 0; i < (c->size_draw); i++) {
...
extern void
gr_system_input(Component *c, MapData *m, SettingsData *s, int key_pressed) {
